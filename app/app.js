...
const elements = {
  ...
  toggleProblems: document.getElementById('toggle-problems'),
...
function setProblemsVisible(visible) {
  ...
  elements.toggleProblems.setAttribute('aria-pressed', String(visible));
...
const actions = {
  ...
  'toggle-problems': () => setProblemsVisible(elements.problems.hidden),
  'toggle-shortcuts': () => {
